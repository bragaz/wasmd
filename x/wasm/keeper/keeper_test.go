...
func TestCreateStoresInstantiatePermission(t *testing.T) {
	var (
		deposit                = sdk.NewCoins(sdk.NewInt64Coin("denom", 100000))
		myAddr  sdk.AccAddress = bytes.Repeat([]byte{1}, types.AddrLen)
	)
...
func TestInstantiateWithDeposit(t *testing.T) {
	var (
		bob  = bytes.Repeat([]byte{1}, types.AddrLen)
		fred = bytes.Repeat([]byte{2}, types.AddrLen)
...
func TestInstantiateWithPermissions(t *testing.T) {
	var (
		deposit   = sdk.NewCoins(sdk.NewInt64Coin("denom", 100000))
		myAddr    = bytes.Repeat([]byte{1}, types.AddrLen)
		otherAddr = bytes.Repeat([]byte{2}, types.AddrLen)
		anyAddr   = bytes.Repeat([]byte{3}, types.AddrLen)
	)
